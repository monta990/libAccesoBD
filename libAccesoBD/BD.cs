...
namespace libAccesoBD
{
    public class BD
    {
        ...
        //SqlConnection con; // mysql conexión
        //SqlCommand com; //comandos a realizar mysql
        ...
        //public static SqlDataReader Lector; //lector mssql
        ...
        //Inicio Modulo MSSQL
        //#region
        ////inicio Conexión BD MSSQL
        //public bool ConectaDB() //inicia conexión a la BD
        //{
        //    bool res = false;
        //    try
        //    {
        //        //con = new SqlConnection("Server = 127.0.0.1;Database=prestamos;Uid=root;Pwd=alvarez");  //offline
        //        con = new SqlConnection("Data Source=LAPDELL\\SQLEXPRESS;Initial Catalog = prestamos; Integrated Security= SSPI; Trusted_Connection = True;");
        //        con = new SqlConnection("Data Source=190.190.200.100,1433;Network Library=DBMSSOCN;Initial Catalog = myDataBase; User ID = myUsername; Password=myPassword;");
        //        con.Open();
        //        res = true;
        //    }
